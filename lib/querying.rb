...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, COUNT(id) count_species
  FROM characters
...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name author, subgenres.name subgenre
  FROM authors
  INNER JOIN series ON
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(character_books.id) count_book
